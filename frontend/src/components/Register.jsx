...
const SEOContent = {
  pageTitle: "Register | BookShop",
  description:
    "This is the register page of BookShop. Here you can register yourself as a new user.",
  keywords:
    "Register, BookShop, User, Registration, Sign Up, New User, Account Creation",
};
