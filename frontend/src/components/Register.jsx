  ...
  return (
    ...
    <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
        ...
        <form onSubmit={handleSubmit(loginFormSubmit)}>
            ...
            <div>
                <input type="submit" value="Register" className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-8 rounded focus:outline-none' />
            </div>
        </form>

        <p className='align-baseline font-medium mt-4 text-sm'>Create Account ? <Link to='/login' className='text-blue-400  hover:underline'>Signin</Link></p>
